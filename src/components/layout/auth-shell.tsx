...
export function AuthShell({ title, subtitle, children }: AuthShellProps) {
  return (
    <main className="relative flex min-h-dvh items-center justify-center overflow-hidden px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      ...
      <section className="relative z-10 w-full max-w-md rounded-3xl border border-slate-200/70 bg-white/90 p-5 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.45)] backdrop-blur sm:p-7">
        <header className="mb-6 space-y-4">
          ...
          <div className="space-y-2">
            <h1 className="font-[family-name:var(--font-heading)] text-2xl text-slate-900 sm:text-3xl">{title}</h1>
